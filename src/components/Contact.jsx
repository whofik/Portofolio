...
import { siteUrl, social, author } from '../constants/settings'
...
function Contact() {
  ...
  const contactSchema = {
    ...
    "@type": "ContactPage",
    "@id": `${siteUrl}/#contact`,
    "name": `Contact ${author.fullName}`,
    "description": `Halaman kontak ${author.fullName}. Hubungi melalui WhatsApp, Telegram, atau Instagram.`,
    "url": `${siteUrl}/#contact`,
    "mainEntity": {
      "@type": "Person",
      "@id": `${siteUrl}/#person`
      ...
      <div className="contact-links">
        {contacts.map((contact) => (
          <a
            ...
            aria-label={`Visit my ${contact.name}`}
          >
